...
** NEXT Run all tests in vm for code coverage			 :AUTOMATION:
...
*** NEXT Run some tests from dll packaged with build and observe if code coverage reports are generated for all program dlls
    :CLOCK:
...
*** DONE Write vision/purpose of code coverage presentation
    ...
    :END:
*** NEXT Research code coverage,  create list of reading material and read
    :CLOCK:
