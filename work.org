...
** PROJECT Selenium testing of MDM
   - State "PROJECT"    from ""           [2010-12-01 Wed 16:49]
*** NEXT Which selenium language binding to use
...
** NEXT Setup Cruise control server
** PROJECT Automate RCH tests
   - State "PROJECT"    from ""           [2010-12-01 Wed 17:25]
*** NEXT Contact Hari for clarification on replacing effective dates on staging loader
